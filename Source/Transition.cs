...
namespace Plets.Core.FiniteStateMachine {
    ...
    public class Transition : IComparable {
        ...
        public Transition (State sourceState, State targetState, string input, string output, bool cycleTransition) : this (sourceState, targetState, input, output) {
            TaggedValues = new Dictionary<string, string> ();
            CycleTransition = cycleTransition;
        }

        public Transition (State sourceState, State targetState, string input, string output, bool cycleTransition, bool lastCycleTrans) : this (sourceState, targetState, input, output, cycleTransition) {
            TaggedValues = new Dictionary<string, string> ();
